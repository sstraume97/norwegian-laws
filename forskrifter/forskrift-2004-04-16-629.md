...
HEMS: En helikopterflyging som skjer i henhold til en HEMS-tillatelse, med det formål å tilby medisinsk akutthjelp i tilfeller der det er avgjørende med umiddelbar og rask transport, ved å være utstyrt med følgende: Medisinsk personell, eller Medisinske forsyninger (utstyr, blod, organer, medikamenter), eller Syke eller skadde personer og andre direkte involverte personer.
...
Fig. 1 – Lysfyr Fig. 2 – Kantlys for FATO/TLOF Fig. 3 Plassering av kantlys

Vedlegg 3 endret ved forskrift 22 feb 2008 nr. 196 .

## Vedlegg 4

Fig. 4

Grønt lys: Yellow boundary: x = 0.313 White boundary: y = 0.243+0.670x Blue boundary: y = 0.493-0.524x Luminance factor: β = 0.10 minimum (day conditions) Relative luminance: 5 % (minimum) to white (night conditions): 30 % (maximum)
...
Vedlegg 4 tilføyd ved forskrift 22 feb 2008 nr. 196 .
