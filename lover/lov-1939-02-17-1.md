...
Eit gjeldsbrev er omsetningsgjeldsbrev når det anten lyder på ihendehavaren eller ikkje seier kven gjelda skal betalast til (ihendehavargjeldsbrev), ellerlyder på namn med tillegget «eller order» eller eit anna slikt tillegg (ordergjeldsbrev), ellergjev pant i fast eigedom eller i skip eller anna innretning som er innført i skipsregisteret, jfsjøloven §§ 11,33og507, eller i luftfartøy som er innført i luftfartøyregisteret, so nær som når det er tilset «ikkje til order» eller eit anna slikt atterhald, ellerlyder på namngjeven mann (namnegjeldsbrev) og endefram seier at det skal vera omsetningsgjeldsbrev.
