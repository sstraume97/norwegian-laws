...
def generate_quarto_config(repo_root: str, lover_dir: str = "lover", version_tags: list[str] = None, db_path: str = None):
    ...
    ver_lines.append(f"- [Søk i lover](sok.qmd) — finn lover etter tittel eller korttittel")
    ver_lines.append(f"- [Sammenlign lovversjon](diff.qmd) — velg lov og to årstall for å se endringer\n")
